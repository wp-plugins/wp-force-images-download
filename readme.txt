...
Usage:
1).     <?php wp_fid();?>
2).     <?php wp_fid("Some Text");?>
Second function allows you to set custom text for download button.e.g. <?php wp_fid("Image Download");?>
...
You have to put this code in single-{post} file.
<?php wp_fid();?>
